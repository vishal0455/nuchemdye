            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6" data-aos="fade-left">
                        <div class="sustainabilty-content">
                            <p>At Nuchem, we are deeply
                                committed to environmental
                                responsibility in every aspect of
                                our manufacturing process.
                            </p>
                            <ul>
                                <li>We prioritize <strong>eco-friendly</strong> production and have
                                    made significant investments in managing
                                    environmental pollution.</li>
                                <li>Our in-house treatment facilities, including MVR and
                                    ATFD systems, enable us to achieve Zero Liquid
                                    Discharge (ZLD) status, ensuring sustainable
                                    wastewater management.</li>
