...
<head>
    ...
    <title>COTFIX VS Series: High-Performance Reactive Dyes for Cellulosic Fibers</title>
    <!-- meta tag -->
    <meta name="description" content="Explore NuChem's COTFIX VS Series, offering high-reactivity vinyl sulfone dyes for cellulosic textiles, ensuring vibrant colors with superior colorfastness and durability." />
    <meta property="og:locale" content="en_in" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="COTFIX VS Series: High-Performance Reactive Dyes for Cellulosic Fibers" />
    <meta property="og:description" content="Explore NuChem's COTFIX VS Series, offering high-reactivity vinyl sulfone dyes for cellulosic textiles, ensuring vibrant colors with superior colorfastness and durability." />
    ...
    <style>
        ...
        @media (max-width: 767px) {
            .cotfixblacks-section .first-box {
...
<body>
    <main>
        ...
        <section class="cotfixblacks-section">
            <div class="first-box first-box-extra" style="background: url(images/cellulosicdyeing-page/cotfix-vs-dyes.jpg) no-repeat top;">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4">
                            ...
                            <div class="box" data-bs-toggle="modal" href="#exampleModalToggle">
                                <div class="black-box" style="background: #167bad;"></div>
                                <div class="text-box">
                                    <p class="title">COTFIX </p>
                                    <p class="subtitle">T.BLUE 266%</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            ...
                            <div class="box" data-bs-toggle="modal" href="#exampleModalToggle">
                                <div class="black-box" style="background:  #051d40;"></div>
                                <div class="text-box">
