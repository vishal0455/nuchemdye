                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 pl" style="display: flex; align-items: center;" data-aos="zoom-in">
                        <div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <a href="cotfixblacks.html">COTFIX BLACKS</a>
                                </div>
                                <div class="col-sm-6">
                                    <a href="cotfixrgbdyes.html">COTFIX RGB SERIES</a>
                                </div>
                                <div class="col-sm-6">
                                    <a href="cotfixvsdyes.html">COTFIX VS SERIES</a>
                                </div>
                                <div class="col-sm-6">
                                    <a href="cotfixrrdyes.html">COTFIX RR SERIES</a>
                                </div>
                                <div class="col-sm-12" style="display: flex; justify-content: center;">
                                    <a href="cotfixmebifunctional.html" style="width: 306px;">COTFIX ME <br>
