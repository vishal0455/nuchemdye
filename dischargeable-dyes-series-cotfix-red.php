...
<body>
    <main>
        ...
        <section class="cotfixblacks-section">
            <div class="first-box" style="background: url(images/dischargeabledyes-page/cotfix-reds.jpg) no-repeat;">
                    ...
                    <div class="row">
                        <div class="col-lg-6 cot-rt">
                            ...
                            <div class="box" data-bs-toggle="modal" href="#exampleModalToggle">
                                <div class="black-box" style="background: #f41823;"></div>
                                <div class="text-box">
                                    <p class="title">COTFIX RED F3B</p>

                                </div>
                            </div>
                            <div class="box" data-bs-toggle="modal" href="#exampleModalToggle">
                                <div class="black-box" style="background: #e34234;"></div>
                                <div class="text-box">
                                    <p class="title">COTFIX RED BB</p>
                        ...
                        <div class="col-lg-6 cot-rl">
                            <!-- <a class="popup-btn" data-bs-toggle="modal" href="#exampleModalToggle">COTFIX BLACK WNN</a> -->
                            <div class="box" data-bs-toggle="modal" href="#exampleModalToggle">
                                <div class="black-box" style="background: #bc1823;"></div>
                                <div class="text-box">
                                    <p class="title">COTFIX DEEP</p>
                                    <p class="subtitle">RED DB</p>
                                </div>
                            </div>
                            <div class="box" data-bs-toggle="modal" href="#exampleModalToggle">
                                <div class="black-box" style="background: #de0f3f;"></div>
                                <div class="text-box">
                                    <p class="title">COTFIX RED W3R</p>
                                </div>
                            </div>
                        </div>
                        <div class="row cotfixred">
                            <div class="col-lg-6 cot-rl">
                                <!-- <a class="popup-btn" data-bs-toggle="modal" href="#exampleModalToggle">COTFIX BLACK WNN</a> -->
                                <div class="box" data-bs-toggle="modal" href="#exampleModalToggle">
                                    <div class="black-box" style="background: #ce0000;"></div>
                                    <div class="text-box">
